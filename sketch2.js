...
let mouthDirection = 1; // 1이면 입을 벌림
...
function playGame() {
  ...
  if (drawPacman) {
    fill(255, 255, 0);
    if (isInvincible) fill(255, 255, 255, 150); // 무적일 때 색 변화
